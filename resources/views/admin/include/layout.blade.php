        ...
        <div class="w-64 bg-white shadow-md h-screen fixed top-0 left-0 flex flex-col">
            <div class="p-5 border-b">
                <div class="flex items-center">
                    <div class="bg-primary w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold text-xl">CB</div>
                    <div class="ml-3">
                        <h2 class="text-xl font-bold text-dark">CharatBox</h2>
